...
const notificationSchema = new mongoose.Schema({
  ...
  source: { type: String, enum: ['shotonme', 'revig'], default: 'shotonme', index: true },
  autoGenerated: { type: Boolean, default: false }, // Was this notification auto-generated by AI?
  sendAt: Date, // Scheduled send time for auto-generated notifications
  targetAudience: {
    type: {
      type: String,
      enum: ['all', 'followers', 'returning-customers', 'new-customers', 'vip', 'custom']
    },
