      ...
      <div className="px-5 py-6 max-w-2xl mx-auto prose prose-invert prose-sm">
        <div className="fizz-card p-5 mb-4">
          <p className="text-white/70 text-sm leading-relaxed">
            Fizz is a product of Shot On Me. Your privacy matters to us. This policy explains what data we collect, why, and how we protect it.
          </p>
        </div>
        ...
        {[
          {
            ...
            body: 'We collect your name, email, phone number, and payment information when you register. We collect transaction history, venue interactions, and location data (only when you opt in) to power the Fizz experience.',
          },
          {
            title: '2. How We Use Your Data',
            body: 'Your data is used to process payments, match you with nearby venues, send Fizz gifts, and personalize your experience. We do not sell your personal data to third parties.',
          },
          {
