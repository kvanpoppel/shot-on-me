      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        {success ? (
          <div className="text-center">
            ...
            <a
              href="/"
              className="inline-block fizz-btn-primary px-8 py-3 text-sm"
            >
              Back to Fizz
            </a>
          </div>
          ...
          <>
            ...
            <p className="text-white/50 text-sm mb-8">Choose a strong password for your Fizz account.</p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    minLength={8}
                    disabled={!token}
                    className="w-full px-4 py-3.5 rounded-xl text-sm font-medium border border-white/10 focus:border-lime-fizz transition-colors pr-12 disabled:opacity-40"
              ...
              <div>
                ...
                <input
                  ...
                  required
                  disabled={!token}
                  className="w-full px-4 py-3.5 rounded-xl text-sm font-medium border border-white/10 focus:border-lime-fizz transition-colors disabled:opacity-40"
                  style={{ background: '#252540' }}
                />
              </div>
              <button
                ...
                className="fizz-btn-primary w-full py-4 text-base mt-2 disabled:opacity-50"
              >
