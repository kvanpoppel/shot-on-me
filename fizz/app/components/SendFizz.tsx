...
import { OCCASION_TAGS, FIZZ_CATEGORIES, EXCLUDED_CATEGORIES } from '../types'
...
export default function SendFizz({ prefillVenueId, onClose }: SendFizzProps) {
  ...
  const [fizzPopped, setFizzPopped] = useState(false)
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.error || err.message || 'Failed to send Fizz')
    } finally {
      setLoading(false)
    }
  }
  ...
  if (step === 'success') {
    return (
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center relative overflow-hidden" style={{ background: '#1A1A2E' }}>
        ...
        <div className={`mb-6 ${fizzPopped ? 'fizz-pop' : ''}`}>
        ...
        <button
          onClick={onClose}
          className="fizz-btn-primary px-8 py-3 text-base"
        >
          Done
        </button>
      </div>
  ...
  return (
    <div className="flex-1 flex flex-col" style={{ background: '#1A1A2E' }}>
      ...
      <div className="flex items-center gap-3 px-5 py-4 border-b border-white/5">
        ...
        <div>
          <h1 className="font-black text-white text-lg" style={{ fontFamily: 'Poppins, sans-serif' }}>Send a Fizz</h1>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5">
        ...
        {step === 'recipient' && (
          <div>
            <h2 className="text-xl font-black text-white mb-1" style={{ fontFamily: 'Poppins, sans-serif' }}>Who gets the Fizz?</h2>
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                className="w-full py-3.5 pl-10 pr-4 rounded-2xl text-sm border border-white/10 focus:border-lime-fizz"
        ...
        {step === 'amount' && (
          <div>
            <h2 className="text-xl font-black text-white mb-1" style={{ fontFamily: 'Poppins, sans-serif' }}>How much to Fizz?</h2>
        ...
        {step === 'occasion' && (
          <div>
            ...
            <button
              ...
              className="fizz-btn-primary w-full py-4 text-base"
            >
              Preview Fizz
            </button>
          </div>
        ...
        {step === 'confirm' && (
          <div>
            ...
            <button
              onClick={handleSend}
              disabled={loading}
              className="fizz-btn-primary w-full py-4 text-base disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {loading ? 'Sending...' : <>
