  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <button
        ...
        className="fizz-btn-primary w-full py-4 text-base disabled:opacity-40 flex items-center justify-center gap-2"
      >
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 rounded-t-3xl px-5 pt-5 pb-10 safe-bottom animate-slide-up" style={{ background: '#1A1A2E', maxHeight: '92vh', overflowY: 'auto' }}>
        ...
        {succeeded ? (
          <div className="py-10 text-center">
            ...
            <p className="text-white/40 text-sm mt-1">${amount.toFixed(2)} added to your Fizz wallet</p>
          </div>
        ) : (
          <>
            {/* Amount selector */}
