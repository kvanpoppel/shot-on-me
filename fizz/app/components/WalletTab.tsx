      ...
      <div className="px-4 mb-4">
        <div className="grid grid-cols-3 gap-3">
          <button
            ...
            className="fizz-card p-4 flex flex-col items-center gap-2 hover:border-lime-fizz/30 transition-all"
          >
          ...
          <button
            ...
            className="fizz-card p-4 flex flex-col items-center gap-2 hover:border-cyan-fizz/30 transition-all"
          >
          ...
          <button
            ...
            className="fizz-card p-4 flex flex-col items-center gap-2 hover:border-coral-fizz/30 transition-all"
          >
        ...
        <div className="mx-4 mb-4 fizz-card p-4 animate-slide-up">
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="e.g. FIZZ2026"
              className="flex-1 px-3 py-2.5 rounded-xl text-sm border border-white/10 focus:border-lime-fizz"
            ...
            <button
              ...
              className="fizz-btn-primary px-4 py-2.5 text-sm disabled:opacity-40"
            >
