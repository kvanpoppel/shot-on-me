    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center" style={{ background: '#1A1A2E' }}>
        ...
        <p className="text-white/50 max-w-xs leading-relaxed mb-6">
          Thanks for applying to join Revig, {form.ownerName.split(' ')[0]}! We&apos;ll review <strong className="text-white">{form.venueName}</strong> and reach out within 2–3 business days.
        </p>
        <div className="revig-card p-4 w-full max-w-xs text-left mb-6">
          <p className="text-xs text-white/40 font-semibold uppercase tracking-wider mb-2">What happens next?</p>
          {['We review your venue', 'Admin approves access', 'You get login credentials', 'Start accepting Revig gifts'].map((step, i) => (
        ...
        <Link href="/" className="revig-btn-primary px-8 py-3 text-sm">
          Back to Revig
        </Link>
      </div>
    )
        ...
        <div className="rounded-3xl p-5 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #252540, #2E2E50)' }}>
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/50 text-sm leading-relaxed">
              Join Revig and let customers send each other gifts redeemable at your venue. 100% commission-free.
            </p>
      ...
      <form onSubmit={handleSubmit} className="px-5 flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3.5 rounded-2xl text-sm border border-white/10 focus:border-lime-revig"
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3.5 rounded-2xl text-sm border border-white/10 focus:border-lime-revig resize-none"
            style={{ background: '#252540' }}
          />
        </div>
        ...
        >
          {loading ? 'Submitting...' : 'Apply to Join Revig'}
        </button>
