          ...
          <div className="rounded-3xl p-6 w-full max-w-sm" style={{ background: '#1C1C32', border: '1px solid rgba(200,241,53,0.2)' }}>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                maxLength={40}
                className="w-full px-4 py-3 rounded-xl text-sm border border-white/10 focus:border-lime-revig"
            ...
            <button
              ...
              className="revig-btn-primary w-full py-3.5 gap-2 disabled:opacity-40"
            >
      ...
      <div className="fixed inset-0 z-50 flex flex-col" style={{ background: '#0F0F1E' }}>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 pb-10">
          ...
          {pendingInvites.map(inv => (
            <div key={inv.squadId} className="revig-card p-4 mb-4" style={{ border: '1px solid rgba(200,241,53,0.25)' }}>
              <p className="font-bold text-white text-sm mb-3">
                {inv.squadEmoji} You&apos;re invited to &quot;{inv.squadName}&quot;!
              </p>
              <div className="flex gap-3">
                <button onClick={() => handleInviteResponse(inv.squadId, true)} className="flex-1 revig-btn-primary py-2.5 text-sm">Join</button>
          ...
          {loading ? (
            ...
            <>
              {/* My Crew */}
              {mySquad ? (
                <div className="revig-card p-5 mb-5" style={{ border: '1px solid rgba(200,241,53,0.2)' }}>
                ...
                <div className="revig-card p-6 text-center mb-5" style={{ border: '2px dashed rgba(200,241,53,0.2)' }}>
                  <Shield className="w-12 h-12 mx-auto mb-3 text-white/20" />
                  <p className="font-semibold text-white/40 mb-1">You&apos;re not in a crew</p>
                  <p className="text-xs text-white/25 mb-4">Create one to compete for the most Reviges in your city</p>
                  <button onClick={() => setShowCreate(true)} className="revig-btn-primary px-6 py-2.5 text-sm gap-2">
