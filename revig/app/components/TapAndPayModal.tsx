    ...
    <>
      ...
      >
        ...
        <div className="rounded-3xl p-6 mb-6 text-center" style={{ background: 'linear-gradient(135deg, #252540 0%, #1A1A2E 100%)', border: '1px solid rgba(200,241,53,0.2)' }}>
          <p className="text-white/50 text-sm mb-1">Your Revig Balance</p>
        ...
        <div className="rounded-3xl p-5 mb-4 text-center" style={{ background: '#252540' }}>
          ...
          <p className="text-white/40 text-xs">They will enter your code to process payment from your Revig wallet</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          {[
            ...
            { icon: <Zap className="w-4 h-4" style={{ color: '#00D4FF' }} />, text: 'Amount is deducted from your Revig wallet instantly' },
