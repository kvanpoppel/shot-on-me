        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 pb-10">
          ...
          <div className="rounded-3xl p-5 relative overflow-hidden mb-5" style={{ background: 'linear-gradient(135deg,#1C1C32,#23233A)', border: '1px solid rgba(200,241,53,0.15)' }}>
            ...
            <div className="relative z-10">
              <p className="text-sm font-semibold text-white/50 mb-1">Invite a friend to Revig</p>
              ...
              <p className="text-xs text-white/35 mb-4">When your friend sends their first Revig, you both get bonus points.</p>
              <button
                onClick={handleShare}
                disabled={sharing}
                className="revig-btn-primary w-full py-3.5 gap-2 text-sm"
              >
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            {[
              ...
              <div key={s.label} className="revig-card p-3 text-center">
          ...
          {loading ? (
            ...
            <div className="flex flex-col gap-3">
              {referrals.map(r => {
                ...
                return (
                  <div key={r.id} className="revig-card p-4">
                    ...
                    <div className="flex items-center gap-4">
                      {[
                        ...
                        { key: 'firstPayment', label: 'First Revig' },
