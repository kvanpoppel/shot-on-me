  ...
  return (
    <div className="flex-1 overflow-y-auto pb-24 px-5" style={{ background: '#0F0F1E' }}>
      ...
      <div className="pt-6 pb-4">
        ...
        <p className="text-xs text-white/40 mt-0.5">All Revig gifts redeemed at your venue</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="fv-card py-16 text-center">
          ...
          <p className="text-white/25 text-sm mt-1">When customers redeem Revig gifts here, they'll show up.</p>
        </div>
      ) : (
        <div className="flex flex-col gap-3">
          {checkins.map(c => {
