...
export default function MessagesTab({ onViewProfile, setActiveTab, activeTab: propActiveTab }: MessagesTabProps) {
  ...
  if (selectedConversation || selectedGroup) {
    ...
    return (
      <div className="flex flex-col bg-black mt-14" style={{ height: 'calc(100dvh - 64px - 56px)' }}>
        {/* Chat Header */}
        <div className="bg-black/95 backdrop-blur-sm border-b border-primary-500/10 p-4 flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 text-primary-400 hover:text-primary-500 transition-colors bg-primary-500/10 hover:bg-primary-500/20 px-3 py-1.5 rounded-lg"
          >
