...
if (!GOOGLE_MAPS_API_KEY) { throw new Error('[GoogleMapsContext] NEXT_PUBLIC_GOOGLE_MAPS_API_KEY is not set. Add it to your .env.local file.') }
const GOOGLE_MAPS_LIBRARIES = ['places']
const GoogleMapsContext = createContext(undefined)
