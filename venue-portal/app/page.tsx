...
const PLANS = [
  ...
  },
  {
    ...
    features: ['Unlimited promotions', 'AI-generated deal copy', 'Guest analytics', 'Social share cards'],
    cta: 'Start Growing',
    highlight: true,
  },
  {
    ...
    features: ['Everything in Growth', 'Auto-posting & scheduling', 'Advanced forecasting', 'Priority support'],
    cta: 'Go Full Auto',
    highlight: false,
  },
]
